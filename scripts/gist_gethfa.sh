...
#I'm shorteing the link with my custom shortner hosted on cloudflare workers
...
url="https://github.com/${repo}/releases/download/${latest_tag}/hfanalyzer_${os}_${arch}_${latest_tag}"
